...
def batch_matrix_to_pycolmap_new(
    points3d,
    extrinsics,
    intrinsics,
    tracks,
...
def batch_matrix_to_pycolmap(
    ...
    for fidx in range(N):
        ...
        # Add Frame/Image to Reconstruction
...
def pycolmap_to_batch_matrix(
    ...
    for i in range(num_images):
        ...
        R, T = get_image_pose_world_to_cam(pyimg) #pyimg.cam_from_world.matrix()

        matrix = np.hstack((R,np.vstack(T)))
