...
- Set the image path to the provided directory of images to be read, resize, and pre-process images for reconstruction
    - image_path = /work/dataset/DTU/scan6_illumination_change
- Set max_images=20 (Never above 40), we want to only use the first 25 images when evaluating the feasibility of the workflow.
