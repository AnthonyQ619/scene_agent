...
- Set the image path to the provided directory of images to be read, resize, and pre-process images for reconstruction
    - image_path = /work/dataset/ETH/office/images/dslr_images_undistorted
- Set max_images=25 (Never above 40), we want to only use the first 20 images when evaluating the feasibility of the workflow.
