...
exhibit consistent lighting, high textured regions, and recorded with incremental movement across sequential images. The goal of 
...
of tools to properly execute the SfM algorithm with detail and computation speed.
"""
...
feature_matcher = FeatureMatchSuperGluePair(detector='sp')

# Feature Tracking Module Initialization
feature_tracker = FeatureMatchSuperGlueTracking(detector='sp')
